# Contributing to RadianceSuite

There are many ways to contribute to RadianceSuite.

- Submit a feature request or bug, or add to the discussion on the [RadianceSuite issue tracker][is]
- Submit a [Pull Request][pr] to improve RadianceSuite.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to RadianceSuite development and you don't have push access to the RadianceSuite
...
When submitting a PR, make sure to add a `Cc: @RadianceSuite/developers` comment to
notify RadianceSuite developers of your awesome contributions. Based on the
...
- You do NOT have push access: A RadianceSuite core developer will integrate your PR.
...
[pr]: https://github.com/RadianceLabs/RadianceSuite/merge_requests
[is]: https://github.com/RadianceLabs/RadianceSuite/issues
