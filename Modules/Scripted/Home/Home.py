...
class HomeWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        self.customLayoutId = self.logic.register_workspace_layout(self.resourcePath("Layouts/RadianceWorkspace.xml"))
    ...
    def setupLayoutButtons(self):
        ...
        self.ui.workspaceLayoutButton.clicked.connect(lambda: self.setLayout(self.customLayoutId))
