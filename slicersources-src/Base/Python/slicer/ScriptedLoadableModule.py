...
""").format(link='<a href="https://www.slicer.org">https://www.slicer.org</a>')
    ...
    def getDefaultModuleDocumentationLink(self, docPage=None):
        ...
        linkText = "<p>" + _("For more information, see the {url_start}online documentation{url_end}.").format(url_start=f'<a href="{url}">', url_end="</a>") + "</p>"
        return linkText
...
class ScriptedLoadableModuleWidget:
    ...
    def _onModuleAboutToBeUnloaded(self, moduleName):
        ...
        if moduleName == self.moduleName:
            ...
            if self.developerMode and hasattr(self, "reloadTestMenuButton"):
                ...
                settings.setValue(f"{self.moduleName}/PreferredReloadAndTestAction", self.reloadTestMenuButton.defaultAction().objectName)
    ...
    def setupDeveloperSection(self):
        ...
        self.editSourceButton.toolTip = "Edit the module's source code. Shift+Click to copy the source code path to the clipboard." " The default editor can be changed in the Python section of the Application Settings."
