...
def IsMRMLIDImageIOAvailable():
    ...
    if not __sitk__MRMLIDImageIO_Missing_Reported__:
        ...
        logging.error("MRMLIDImageIO is not available, SimpleITK image transfer speed will be slower." " Probably an extension replaced SimpleITK version that was bundled with Slicer." f" Current SimpleITK version: {sitk.__version__}")
