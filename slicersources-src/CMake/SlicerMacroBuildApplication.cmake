    ...
    if(Slicer_USE_CTKAPPLAUNCHER)
      ...
      if(NOT APPLE)
        if(Slicer_HAS_CONSOLE_LAUNCHER)
          ...
          # Copy GUI launcher (W) over root exe for build tree - overwrites console launcher from ConfigureLauncher
          add_custom_target(${SLICERAPP_APPLICATION_NAME}CopyLauncherForBuildTree ALL
            COMMAND ${CMAKE_COMMAND} -E copy
              ${Slicer_BINARY_DIR}/CMakeFiles/${SLICERAPP_APPLICATION_NAME}W${CMAKE_EXECUTABLE_SUFFIX}
              ${Slicer_BINARY_DIR}/${SLICERAPP_APPLICATION_NAME}${CMAKE_EXECUTABLE_SUFFIX}
            COMMENT "Copy Windows GUI launcher over console launcher for build tree"
            )
          add_dependencies(${SLICERAPP_APPLICATION_NAME}CopyLauncherForBuildTree ${SLICERAPP_APPLICATION_NAME}UpdateLauncherWIcon)
          set_target_properties(${SLICERAPP_APPLICATION_NAME}CopyLauncherForBuildTree PROPERTIES FOLDER ${SLICERAPP_FOLDER})
