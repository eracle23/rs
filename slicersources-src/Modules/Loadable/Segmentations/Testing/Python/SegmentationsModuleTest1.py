...
class SegmentationsModuleTest1(unittest.TestCase):
    ...
    def TestSection_RetrieveInputData(self):
        try:
            slicer.util.downloadAndExtractArchive(TESTING_DATA_URL + "SHA256/b902f635ef2059cd3b4ba854c000b388e4a9e817a651f28be05c22511a317ec7", self.dataZipFilePath, self.segmentationsModuleTestDir, checksum="SHA256:b902f635ef2059cd3b4ba854c000b388e4a9e817a651f28be05c22511a317ec7")
