        ...
        if eventId == vtk.vtkCommand.LeftButtonPressEvent and not anyModifierKeyPressed:
            ...
            if pipeline.actionState == "":
                ...
                if pipeline.preview(xy):
                    ...
                    self.sliceRotatedErrorLabel.text = '<b><font color="red">' + _("Slice view is not aligned with segmentation axis.<br>To use this effect, click the 'Slice views orientation' warning button.") + "</font></b>"
                abortEvent = True
                self.lastXY = xy
