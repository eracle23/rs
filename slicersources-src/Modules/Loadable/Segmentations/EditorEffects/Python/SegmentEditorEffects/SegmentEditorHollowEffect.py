...
class SegmentEditorHollowEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.applyToAllVisibleSegmentsCheckBox.setToolTip(_("Apply hollow effect to all visible segments in this segmentation node. This operation may take a while."))
