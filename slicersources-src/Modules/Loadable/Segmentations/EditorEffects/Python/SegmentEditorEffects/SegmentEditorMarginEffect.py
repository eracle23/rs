...
class SegmentEditorMarginEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.marginSizeMMSpinBox.setToolTip(_("Segment boundaries will be shifted by this distance. " "Positive value means the segments will grow, negative value means segment will shrink."))
        ...
        self.applyToAllVisibleSegmentsCheckBox.setToolTip(_("Grow or shrink all visible segments in this segmentation node. This operation may take a while."))
        ...
        try:
            ...
            if applyToAllVisibleSegments:
                ...
                for index in range(inputSegmentIDs.GetNumberOfValues()):
                    ...
                    self.showStatusMessage(_("Processing {segmentName}...").format(segmentName=segmentationNode.GetSegmentation().GetSegment(segmentID).GetName()))
