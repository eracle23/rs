...
void qSlicerSegmentationsModuleWidget::init()
{
  Q_D(qSlicerSegmentationsModuleWidget);
  d->setupUi(this);
  d->MRMLNodeComboBox_Segmentation->setNodeTypeLabel(tr("Segmentation"), "vtkMRMLSegmentationNode");
  d->MRMLNodeComboBox_Segmentation->setBaseName(tr("Segmentation"), "vtkMRMLSegmentationNode");
