...
void qMRMLSegmentEditorWidgetPrivate::init()
{
  ...
  this->SegmentationNodeComboBox->setNodeTypeLabel(qMRMLSegmentEditorWidget::tr("Segmentation"), "vtkMRMLSegmentationNode");
  this->SegmentationNodeComboBox->setBaseName(qMRMLSegmentEditorWidget::tr("Segmentation"), "vtkMRMLSegmentationNode");
  this->SourceVolumeNodeComboBox->setNodeTypeLabel(qMRMLSegmentEditorWidget::tr("Volume"), "vtkMRMLScalarVolumeNode");
