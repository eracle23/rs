...
class SubjectHierarchyCorePluginsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def section_CloneNode(self):
        ...
        inSameStudy = slicer.vtkSlicerSubjectHierarchyModuleLogic.AreItemsInSameBranch(shNode, markupsShItemID, clonedMarkupsShItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMLevelStudy())
