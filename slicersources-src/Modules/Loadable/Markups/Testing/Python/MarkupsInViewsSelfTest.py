...
class MarkupsInViewsSelfTestLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self):
        ...
        fidNodeObserverTags = []
        self.nodeEvents = []
        observedEvents = [slicer.vtkMRMLMarkupsNode.PointPositionDefinedEvent, slicer.vtkMRMLMarkupsNode.PointPositionUndefinedEvent]
        ...
        if not self.controlPointVisible3D(fidNode, "vtkMRMLViewNode1", controlPointIndex) or not self.controlPointVisible3D(fidNode, "vtkMRMLViewNode2", controlPointIndex):
        ...
        if self.controlPointVisibleSlice(fidNode, "vtkMRMLSliceNodeRed", controlPointIndex) or not self.controlPointVisibleSlice(fidNode, "vtkMRMLSliceNodeGreen", controlPointIndex):
