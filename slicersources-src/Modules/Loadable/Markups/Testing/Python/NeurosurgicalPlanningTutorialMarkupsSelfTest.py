...
class NeurosurgicalPlanningTutorialMarkupsSelfTestTest(ScriptedLoadableModuleTest):
    ...
    def test_NeurosurgicalPlanningTutorialMarkupsSelfTest1(self):
        ...
        clickCoordsList = [[-7.4, 71, sliceOffset], [-11, 73, sliceOffset], [-12, 85, sliceOffset], [-13, 91, sliceOffset], [-15, 78, sliceOffset]]
        sliceWidget = lm.sliceWidget("Red")
        currentCoords = None
        ...
        clickCoordsList = [[-40, 50, sliceOffset], [30, 50, sliceOffset], [30, 145, sliceOffset], [-40, 145, sliceOffset], [-40, 50, sliceOffset]]
        sliceWidget = lm.sliceWidget("Red")
        currentCoords = None
        for clickCoords in clickCoordsList:
            if currentCoords:
