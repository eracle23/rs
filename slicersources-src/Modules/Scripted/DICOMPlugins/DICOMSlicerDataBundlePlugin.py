...
class DICOMSlicerDataBundlePluginClass(DICOMPlugin):
    ...
    def export(self, exportables):
        ...
        for exportable in exportables:
            ...
            dicomUid = shNode.GetItemUID(exportable.subjectHierarchyItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMUIDName())
            if not dicomUid:
                continue
        ...
        tags["PatientBirthDate"] = exportable.tag(slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientBirthDateTagName())
        tags["PatientSex"] = exportable.tag(slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientSexTagName())
        tags["PatientComments"] = exportable.tag(slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientCommentsTagName())
        ...
        tags["StudyDescription"] = exportable.tag(slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyDescriptionTagName())
