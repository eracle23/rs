            ...
            for patient in slicer.dicomDatabase.patients():
                ...
                for study in slicer.dicomDatabase.studiesForPatient(patient):
                    ...
                    try:
                        ...
                        studyDataset[self.retrieveURLTag] = pydicom.dataelem.DataElement(0x00080190, "UR", "http://example.com")  # TODO: provide WADO-RS RetrieveURL
                        ...
                        studyDataset[self.numberOfStudyRelatedSeriesTag] = pydicom.dataelem.DataElement(self.numberOfStudyRelatedSeriesTag, "IS", str(numberOfStudyRelatedSeries))
                        studyDataset[self.numberOfStudyRelatedInstancesTag] = pydicom.dataelem.DataElement(self.numberOfStudyRelatedInstancesTag, "IS", str(numberOfStudyRelatedInstances))
    ...
    def handleInstances(self, parsedURL, _requestBody):
        ...
        if len(splitPath) == 7:  # .../instances
            ...
            for instance in instances:
                ...
                instanceDataset[self.retrieveURLTag] = pydicom.dataelem.DataElement(0x00080190, "UR", "http://example.com")  # TODO: provide WADO-RS RetrieveURL
