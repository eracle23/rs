...
""".replace("%%sizes%%", sizes)
    ...
    def accessDICOMwebStudy(self, request, requestBody):
        ...
        loadedUIDs = DICOMUtils.importFromDICOMWeb(dicomWebEndpoint=request["dicomWEBPrefix"] + "/" + request["dicomWEBStore"], studyInstanceUID=request["studyUID"], accessToken=request["accessToken"])
