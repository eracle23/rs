...
class SegmentStatisticsPluginBase:
    ...
    @staticmethod
    def createMeasurementInfo(name, title, description, units, quantityDicomCode=None, unitsDicomCode=None, measurementMethodDicomCode=None, derivationDicomCode=None, componentNames=None):
