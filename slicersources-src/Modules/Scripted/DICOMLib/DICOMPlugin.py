...
class DICOMPlugin:
    ...
    def addSeriesInSubjectHierarchy(self, loadable, dataNode):
        ...
        shn.SetItemAttribute(seriesItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMReferencedInstanceUIDsAttributeName(), referencedInstanceUIDs)
        ...
        if not patientItemID:
            ...
            if patientItemID:
                ...
                shn.SetItemAttribute(patientItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientNameAttributeName(), patientName)
                shn.SetItemAttribute(patientItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientIDAttributeName(), patientId)
                shn.SetItemAttribute(patientItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientSexAttributeName(), slicer.dicomDatabase.fileValue(firstFile, tags["patientSex"]))
                patientBirthDate = slicer.dicomDatabase.fileValue(firstFile, tags["patientBirthDate"])
                shn.SetItemAttribute(patientItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientBirthDateAttributeName(), patientBirthDate)
                shn.SetItemAttribute(patientItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMPatientCommentsAttributeName(), slicer.dicomDatabase.fileValue(firstFile, tags["patientComments"]))
                # Set item name
        ...
        if not studyItemID:
            ...
            if studyItemID:
                ...
                shn.SetItemAttribute(studyItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyDescriptionAttributeName(), studyDescription)
                ...
                shn.SetItemAttribute(studyItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyIDAttributeName(), studyId)
                shn.SetItemAttribute(studyItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyDateAttributeName(), studyDate)
                shn.SetItemAttribute(studyItemID, slicer.vtkMRMLSubjectHierarchyConstants.GetDICOMStudyTimeAttributeName(), slicer.dicomDatabase.fileValue(firstFile, tags["studyTime"]))
                # Set item name
