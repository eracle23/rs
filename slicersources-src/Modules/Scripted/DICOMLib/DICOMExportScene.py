...
"""
        ...
        args = ["-k", f"SeriesDescription={seriesDescription}", "--no-latin1"]  # With this option the UTF8 encoding of the reference file is preserved, otherwise the character set would be forced to Latin1
        ...
        args += [
            "--dataset-from",
            templateFile,  # input DICOM file (generated by dump2dcm, already contains the MRB)
            imageFile,  # thumbnail
            self.sdbFile,
        ]  # output file
