...
class EditableTreeWidget(qt.QTreeWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Set up context menu
        self._shiftUpAction = _makeAction(self, text=_("Move &Up"), icon="arrow-up", shortcut="ctrl+shift+up", slot=self.shiftSelectionUp)

        self._shiftDownAction = _makeAction(self, text=_("Move &Down"), icon="arrow-down", shortcut="ctrl+shift+down", slot=self.shiftSelectionDown)

        self._deleteAction = _makeAction(self, text=_("&Delete"), icon="edit-delete", shortcut="del", slot=self.deleteSelection)
