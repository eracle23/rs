...
class DataProbeInfoWidget:
    ...
    def processEvent(self, observee, event):
        ...
        hasVolume = False
        layerLogicCalls = (("L", sliceLogic.GetLabelLayer), ("F", sliceLogic.GetForegroundLayer), ("B", sliceLogic.GetBackgroundLayer))
        ...
        if (not slicer.mrmlScene.IsBatchProcessing()) and sliceLogic and hasVolume and self.showImage:
            pixmap = self._createMagnifiedPixmap(xyz, sliceLogic.GetBlend().GetOutputPort(), self.imageLabel.size, color)
            if pixmap:
...
class DataProbeTest(ScriptedLoadableModuleTest):
    ...
    def test_DataProbe1(self):
        ...
        SampleData.downloadFromURL(nodeNames="FA", fileNames="FA.nrrd", uris=TESTING_DATA_URL + "SHA256/12d17fba4f2e1f1a843f0757366f28c3f3e1a8bb38836f0de2a32bb1cd476560", checksums="SHA256:12d17fba4f2e1f1a843f0757366f28c3f3e1a8bb38836f0de2a32bb1cd476560")
