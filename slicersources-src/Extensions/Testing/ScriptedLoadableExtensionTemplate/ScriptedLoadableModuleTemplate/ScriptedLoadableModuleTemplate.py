...
class ScriptedLoadableModuleTemplateWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.imageThresholdSliderWidget.setToolTip(_("Set threshold value for computing the output image. Voxels that have intensities lower than this value will set to zero."))
...
class ScriptedLoadableModuleTemplateTest(ScriptedLoadableModuleTest):
    ...
    def test_ScriptedLoadableModuleTemplate1(self):
        ...
        volumeNode = SampleData.downloadFromURL(nodeNames="MRHead", fileNames="MR-head.nrrd", uris=TESTING_DATA_URL + "SHA256/cc211f0dfd9a05ca3841ce1141b292898b2dd2d3f08286affadf823a7e58df93", checksums="SHA256:cc211f0dfd9a05ca3841ce1141b292898b2dd2d3f08286affadf823a7e58df93")
