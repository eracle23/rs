...
class CustomClassSerializer(Serializer):
    ...
    def create(type_):
        ...
        if CustomClassSerializer.canSerialize(type_):
            ...
            return ValidatedSerializer(
                CustomClassSerializer(), [NotNone(), IsInstance(CustomClass)]
            )
        return None
    ...
    def write(
        self, parameterNode: slicer.vtkMRMLScriptedModuleNode, name: str, value
    ) -> None:
        """
    ...
    def remove(
        self, parameterNode: slicer.vtkMRMLScriptedModuleNode, name: str
    ) -> None:
        """
