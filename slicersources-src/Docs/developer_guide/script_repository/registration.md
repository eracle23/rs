...
transformedMovingVolumeNode = slicer.mrmlScene.AddNewNodeByClass(
...
cliBrainsFitRigidNode = slicer.cli.run(
    slicer.modules.brainsfit, None, parameters, wait_for_completion=True
)
...
slicer.util.setSliceViewerLayers(
    fixedVolumeNode, movingVolumeNode, foregroundOpacity=0.5
)
```
