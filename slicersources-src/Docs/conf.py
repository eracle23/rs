...
def _extract_slicer_xy_version(slicer_src_dir):
    ...
    version_patterns = {part: re.compile(rf'set\(Slicer_VERSION_{part.upper()} "(\d+)"\)') for part in ["major", "minor"]}
    version_parts = {}
...
latex_documents = [
    (master_doc, "3DSlicer.tex", "3D Slicer Documentation", "Slicer Community", "manual"),
]
...
man_pages = [
    (master_doc, "3Dslicer", "3D Slicer Documentation", [author], 1),
]
...
texinfo_documents = [
    (master_doc, "3DSlicer", "3D Slicer Documentation", author, "3DSlicer", "One line description of project.", "Miscellaneous"),
]
