...
class RSNAQuantTutorialTest(ScriptedLoadableModuleTest):
    ...
    def test_Part3PETCT(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        extractPath = SampleData.downloadFromURL(fileNames="dataset3_PETCT.zip", loadFileTypes="ZipFile", uris=TESTING_DATA_URL + "SHA256/11e81af3462076f4ca371b632e03ed435240042915c2daf07f80059b3f78f88d", checksums="SHA256:11e81af3462076f4ca371b632e03ed435240042915c2daf07f80059b3f78f88d")[0]
    ...
    def test_Part2ChangeTracker(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        SampleData.downloadFromURL(fileNames="ChangeTrackerScene.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/64734cbbf8ebafe4a52f551d1510a8f6f3d0625eb5b6c1e328be117c48e2c653", checksums="SHA256:64734cbbf8ebafe4a52f551d1510a8f6f3d0625eb5b6c1e328be117c48e2c653")
