...
if __name__ == "__main__":
    ...
    all = not args.normal and not args.modules_to_load and not args.overall and not args.excluding_one_module and not args.including_one_module
    ...
    if args.modules_to_load:
        collect_startup_times_modules_to_load("StartupTimesSelectedModules.json", args.modules_to_load, module_list, **common_kwargs)
    ...
    if all or args.excluding_one_module:
        collect_startup_times_excluding_one_module("StartupTimesExcludingOneModule-r%s.json" % sliver_revision, module_list, **common_kwargs)

    if all or args.including_one_module:
        collect_startup_times_including_one_module("StartupTimesIncludingOneModule-r%s.json" % sliver_revision, module_list, **common_kwargs)
