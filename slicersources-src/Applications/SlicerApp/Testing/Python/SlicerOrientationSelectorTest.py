...
class SlicerOrientationSelectorTest(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.contributors = ["Jean-Christophe Fillion-Robin (Kitware)", "Davide Punzo (Kapteyn astronomical institute)"]  # replace with "Firstname Lastname (Organization)"
