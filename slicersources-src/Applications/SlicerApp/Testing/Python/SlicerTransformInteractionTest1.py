...
class SlicerTransformInteractionTest1Test(ScriptedLoadableModuleTest):
    ...
    def test_3D_interactionVolume(self):
        ...
        for i in range(4):
            defaultPlusMovePlusRotationPlusScalingTransform.append([x * scale[i] for x in defaultPlusMovePlusRotationTransform[i]])
        ...
        for i in range(4):
            volumePlusMovePlusRotationPlusScalingTransform.append([x * scale[i] for x in volumePlusMovePlusRotationTransform[i]])
