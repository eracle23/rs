...
if __name__ == "__main__":
    ...
    required_inputs = [
        "--transform1",
        "%s/ExecutionModelTourTestPython.mrml#vtkMRMLLinearTransformNode1" % (temp_dir),
        "--transform2",
        "%s/ExecutionModelTourTestPython.mrml#vtkMRMLLinearTransformNode2" % (temp_dir),
        mrHeadResampled,
        ctHeadAxial,
    ]
    serialize_options = [
