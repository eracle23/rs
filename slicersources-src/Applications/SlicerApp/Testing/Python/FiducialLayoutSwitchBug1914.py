...
class FiducialLayoutSwitchBug1914Test(ScriptedLoadableModuleTest):
    ...
    def test_FiducialLayoutSwitchBug1914(self):
        ...
        if diff > maximumDisplayDifference:
            ...
            print("Checking the difference between point RAS position", seedRAS, "and volume RAS as derived from the point display position", volumeRAS, ": ", rasDiff)
        ...
        if enableScreenshots == 1:
            ...
            annotationLogic.CreateSnapShot("FiducialLayoutSwitchBug1914-Diff", "Difference between starting and ending point positions", slicer.qMRMLScreenShotDialog.Red, screenshotScaleFactor, shotDiff)
