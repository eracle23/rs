...
class RSNAVisTutorialTest(ScriptedLoadableModuleTest):
    ...
    def test_Part1DICOM(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        dicomFilesDirectory = SampleData.downloadFromURL(fileNames="dataset1_Thorax_Abdomen.zip", loadFileTypes="ZipFile", uris=TESTING_DATA_URL + "SHA256/17a4199aad03a373dab27dc17e5bfcf84fc194d0a30975b4073e5b595d43a56a", checksums="SHA256:17a4199aad03a373dab27dc17e5bfcf84fc194d0a30975b4073e5b595d43a56a")[0]
    ...
    def test_Part2Head(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        SampleData.downloadFromURL(fileNames="Head_Scene.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/6785e481925c912a5a3940e9c9b71935df93a78a871e10f66ab71f8478229e68", checksums="SHA256:6785e481925c912a5a3940e9c9b71935df93a78a871e10f66ab71f8478229e68")
    ...
    def test_Part3Liver(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        SampleData.downloadFromURL(fileNames="LiverSegments_Scene.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/ff797140c13a5988a7b72920adf0d2dab390a9babeab9161d5c52613328249f7", checksums="SHA256:ff797140c13a5988a7b72920adf0d2dab390a9babeab9161d5c52613328249f7")
    ...
    def test_Part4Lung(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        SampleData.downloadFromURL(fileNames="LungSegments_Scene.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/89ffc6cabd76a17dfa6beb404a5901a4b4e4b4f2f4ee46c2d5f4d34459f554a1", checksums="SHA256:89ffc6cabd76a17dfa6beb404a5901a4b4e4b4f2f4ee46c2d5f4d34459f554a1")
