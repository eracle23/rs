    ...
    def onStartStopDicomPeer(self, flag):
        if flag:
            ...
            if slicer.util.confirmYesNoDisplay("Do you want to choose local DCMTK database folder?"):
                ...
                SampleData.downloadFromURL(fileNames="Dcmtk-db.zip", loadFileTypes="ZipFile", uris=TESTING_DATA_URL + "MD5/6bfb01cf5ffb8e3af9b1c0c9556f0c6b45f0ec40305a9539ed7a9f0dcfe378e3", checksums="SHA256:6bfb01cf5ffb8e3af9b1c0c9556f0c6b45f0ec40305a9539ed7a9f0dcfe378e3")[0]
...
class JRC2013VisTest(ScriptedLoadableModuleTest):
    ...
    def test_Part1DICOM(self):
        ...
        dicomFilesDirectory = SampleData.downloadFromURL(fileNames="Dcmtk-db.zip", loadFileTypes="ZipFile", uris=TESTING_DATA_URL + "MD5/7a43d121a51a631ab0df02071e5ba6ed", checksums="MD5:7a43d121a51a631ab0df02071e5ba6ed")[0]
    ...
    def test_Part2Head(self):
        ...
        SampleData.downloadFromURL(fileNames="3DHeadData.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/e2c7944095dd92be7961bed37f3c8f49e6f40c7f31d4fe865753b6efddae7993", checksums="SHA256:e2c7944095dd92be7961bed37f3c8f49e6f40c7f31d4fe865753b6efddae7993")
    ...
    def test_Part3Liver(self):
        ...
        SampleData.downloadFromURL(fileNames="LiverData.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/a39075d3e87f80bbf8eba1e0222ee68c60036e57c3db830db08f3022f424e221", checksums="SHA256:a39075d3e87f80bbf8eba1e0222ee68c60036e57c3db830db08f3022f424e221")
        self.delayDisplay("Finished with download and loading\n")
    ...
    def test_Part4Lung(self):
        ...
        SampleData.downloadFromURL(fileNames="LungData.mrb", loadFiles=True, uris=TESTING_DATA_URL + "SHA256/9da091065aa42edbba2d436a2ef21a093792e8a76455c28e5b80590b04f5a73e", checksums="SHA256:9da091065aa42edbba2d436a2ef21a093792e8a76455c28e5b80590b04f5a73e")
        self.delayDisplay("Finished with download and loading\n")
