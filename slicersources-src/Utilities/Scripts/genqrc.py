...
def main(argv):
    ...
    parser.add_argument("-o", dest="out_path", metavar="PATH", default="-", help="location to which to write the output .qrc file" " (default=stdout)")
    parser.add_argument("resource_directories", nargs="+", help="list of directories containing resource files")

    args = parser.parse_args(argv)

    qrc_content = ["<!DOCTYPE RCC>", "<!--", "  This file was automatically generated by %s %r" % (os.path.basename(__file__), args.resource_directories), "  See %s/%s for more information." % ("https://www.slicer.org/w/index.php", "Documentation/Nightly/Developers/Build_system/Qt_resource_files"), "-->", "", '<RCC version="1.0">', ""]
