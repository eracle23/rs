...
def update_external_project_python_packages(packages_to_update, directory, cpython_tag):
    ...
    for package_name, (current_version, latest_version) in packages_to_update.items():
        ...
        if not hashes:
            print(f"ERROR UPDATING '{package_name}': Unable to find latest version for specified python version." + "This package might need an updated package version for the specified CPython tag.")
            continue
