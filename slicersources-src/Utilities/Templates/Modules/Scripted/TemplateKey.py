...
class TemplateKey(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("TemplateKey")  # TODO: make this more human readable by adding spaces
    ...
    def onApplyButton(self) -> None:
        ...
        with slicer.util.tryWithErrorDisplay(_("Failed to compute results."), waitCursor=True):
            ...
            if self.ui.invertedOutputSelector.currentNode():
                ...
                self.logic.process(self.ui.inputSelector.currentNode(), self.ui.invertedOutputSelector.currentNode(), self.ui.imageThresholdSliderWidget.value, not self.ui.invertOutputCheckBox.checked, showResult=False)
...
class TemplateKeyLogic(ScriptedLoadableModuleLogic):
    ...
    def process(self, inputVolume: vtkMRMLScalarVolumeNode, outputVolume: vtkMRMLScalarVolumeNode, imageThreshold: float, invert: bool = False, showResult: bool = True) -> None:
        """
