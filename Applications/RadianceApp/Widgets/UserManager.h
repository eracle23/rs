...
namespace UserLockReason
{
constexpr int None = 0;
constexpr int PasswordFailures = 1;
constexpr int AdminManual = 2;
} // namespace UserLockReason
...
struct UserInfo
{
  ...
  int failedAttempts;
  QDateTime lockedAt;
  int lockReason = UserLockReason::None;
};

namespace UserManagerLimits
{
constexpr int MinUsernameLength = 1;
constexpr int MaxUsernameLength = 50;
constexpr int MaxFailedLoginAttempts = 5;
constexpr int PasswordLockDurationMinutes = 15;
} // namespace UserManagerLimits
