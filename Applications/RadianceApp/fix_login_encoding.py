...
replacements = [
    ...
    (
        'TitleLabel = new QLabel(QString::fromUtf8("??????????"));',
        'TitleLabel = new QLabel(QString::fromUtf8("医学影像三维重建软件"));',
    ),
    (
        'SubtitleLabel = new QLabel(QString::fromUtf8("??????????"));',
        'SubtitleLabel = new QLabel(QString::fromUtf8("请登录以继续使用软件"));',
    ),
    (
        'UsernameLabel = new QLabel(QString::fromUtf8("????"));',
    ...
    (
        'PasswordLabel = new QLabel(QString::fromUtf8("???"));',
    ...
    (
        'LoginButton = new QPushButton(QString::fromUtf8("??"));',
        'LoginButton = new QPushButton(QString::fromUtf8("登录"));',
    ),
    (
        'ForgotPasswordButton = new QPushButton(QString::fromUtf8("?????"));',
        'ForgotPasswordButton = new QPushButton(QString::fromUtf8("忘记密码？"));',
    ),
    (
        'ExitButton = new QPushButton(QString::fromUtf8("??"));',
    ...
    (
        'd->LoginButton->setText(QString::fromUtf8("???..."));',
    ...
    (
        'QMessageBox::information(this, QString::fromUtf8("????"), message);',
